...
describe('stringMeDuckTyping',function(){
  ...
  describe('Anything as param',function(){
    it('When param is 3, Then returns ""',function(){
      expect( stringMeDuckTyping( 3 ) ).toEqual('');
    });
    it('When param is 3.2, Then returns ""',function(){
      expect( stringMeDuckTyping( 3.2 ) ).toEqual('');
    });
    it('When param is "hola", Then returns ""',function(){
      expect( stringMeDuckTyping( "hola" ) ).toEqual('');
    });
    it('When param is function(){}, Then returns ""',function(){
      expect( stringMeDuckTyping( function(){} ) ).toEqual('');
    });
  });
  
  describe('There isnt elements',function(){
    it('When param is <nothing>, Then returns ""',function(){
      expect( stringMeDuckTyping( '' ) ).toEqual('');
    });
    it('When param is [],Then returns ""',function(){
      expect( stringMeDuckTyping( [] ) ).toEqual('');
    });
  });
  
  describe('Array with strings',function(){
    it('When param is [\'hola\'],Then returns \'hola\'',function(){
      expect( stringMeDuckTyping( ['hola'] ) ).toEqual('hola');
    });
    
    it('When param is [\'hola\',\'que\',\'tal\'],Then returns \'hola,que,tal\'',function(){
      expect( stringMeDuckTyping( ['hola','que','tal'] ) ).toEqual('hola,que,tal');
    });
  });
  
  describe('Array with array and string elements',function(){
    it('When param is [\'hola\',[\'soy\',\'luis\']],Then returns \'hola,soy,luis\'',function(){
      expect( stringMeDuckTyping( ["hola",["soy","luis"]] ) ).toEqual('hola,soy,luis');
    });
    
    it('When param is  [\'hola\',[\'soy\',\'luis\'],\'y\',\'estoy\',\'bien\'], Then returns \'hola,soy,luis,y,estoy,bien\'',function(){
      expect( stringMeDuckTyping( ["hola",["soy","luis"],"y","estoy","bien"] ) ).toEqual('hola,soy,luis,y,estoy,bien');
    });
  });
  
  describe('Array with array and string elements',function(){
    it('When param is [\'hola\', [\'soy\', [\'juan\', \'fernandez\'] ], \'y\', [\'no\', \'tengo\', [\'dinero\'] ] ],Then returns \'hola,soy,juan,fernandez,y,no,tengo,dinero\'',function(){
